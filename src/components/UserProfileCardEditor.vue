  ...
  <div class="col-3 push-top">
        <div class="profile-card">
            ...
            <div class="btn-group space-between">
                ...
                <button type="submit" @click="save" class="btn-blue">Save</button>
            </div>
        </div>
...
export default {
    ...
    data() {
        return {
            // activeUser: this.user // if use like this it will be affacted to state, need to clone as below
    ...
    methods: {
        save() {
            this.$store.dispatch('users/updateUser', {...this.activeUser}); // clone current updated user because dispatch to avoid update state date
